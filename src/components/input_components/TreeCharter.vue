...
td{position: relative; vertical-align: top;padding:0 0 5px 0;text-align: center; }
...
.node .person{position: relative; display: inline-block;z-index: 2;width:4em; overflow: hidden;}
.node .person .avat{display: block;width:4em;height: 4em;margin:auto;overflow:hidden; background:#fff;border:none #ccc;box-sizing: border-box;}
